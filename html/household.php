...
.card-one{
    width: 86%;
    height: 250%;
    background: linear-gradient( #1E4460 90%, #1E4460 90%, white 90%);
...
<body>
                ...
                <button onclick="toggleSubMenu(this)" class="dropdown-btn">
                    ...
                    <ul class="sub-menu show">
                        <div>
                          ...
                          <li class="activate"><a href="household.php" class="size" >Household Records</a></li>
    ...
    <main>
        ...
        <div class="center">
            <h1><code>Welcome to the Barangay Administrative Portal of</code><br>HOUSEHOLD RECORDS</h1>
        </div>  
        <div class="circle">
            <img id="st" src="../img/logs.jpg" alt="">  
          </div>
        ...
        <div class="add">
            <p><code id="list">List of Household and Members</code><br>LIST OF REQUESTED ID</p>
        ...
        <div  class="sec">
            <div class="card-one">
                <p class="housenumber">HOUSE NO.</p>
                <input type="text" class="purok">
                <p class="household">HOUSEHOLD MEMBER</p>
                <input type="text" class="member">
            </div>
