...
<div class="certificate-container" id="certificate">
    ...
    <!-- Certificate Title -->
    <div class="certificate-title">Certificate of Clearance</div>
    ...
    <p>
            ...
            and a bonafide resident of Barangay Nueva Victoria, Municipality of Mexico, Province of Pampanga, is known to us as a 
            person of good moral character and is a member of the community.
        </p>
        <p>
            This clearance is issued upon the request of <strong><?php echo htmlspecialchars($resident['name']); ?></strong> 
            for the purpose of <strong><?php echo htmlspecialchars($resident['purpose']); ?></strong>. 
            This clearance certifies that the resident is free from any pending obligations or liabilities to the Barangay.
        </p>
        <p>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    backgroundColor: null,
            ...
            const fileName = `Certificate_of_Clearance_${residentName.replace(/ /g, "_")}.pdf`;
            pdf.save(fileName);
        });
    });
