...
<body>
                ...
                <button onclick="toggleSubMenu(this)" class="dropdown-btn rotate">
                    ...
                    <ul class="sub-menu show">
                        <div>
                          ...
                          <li class="activate"><a href="id.php" class="size" >Barangay ID</a></li>
                        </div>
                    </ul>
    ...
    <main>
        ...
        <div class="center">
            <h1><code>Welcome to the Barangay Administrative Portal of</code><br>BARANGAY ID</h1>
        </div>  
        <div class="circle">
            <img id="st" src="../img/logs.jpg" alt="">  
          </div>
