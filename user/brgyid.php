...
<body>
    ...
    <div class="container">
        <form action="brgyid2.php" method="post">
            ...
            <input type="tel" placeholder="Contact No." name="contact_no" required>
            <p>Birthday</p>
            <input type="date" placeholder="Birthday" name="birthday" required>
            <p>Date Issued</p>
            <input type="date" placeholder="Date Issued" name="date_issued" required>
            <span>*Upload E-signature (mag upload ng digital na pirma)</span>
            <label class="upload-box">
                Click here or Drop files to upload or transfer
                <input type="file" name="proof_of_residency" accept="image/*" required>
            </label>
            


            <h2>*Emergency Information</h2>
            <input type="text" placeholder="Emergency Contact Name" name="emergency_name" required>
            <input type="text" placeholder="Emergency Contact Address" name="emergency_address" required>
            <input type="tel" placeholder="Emergency Contact No." name="emergency_contact_no" required>
