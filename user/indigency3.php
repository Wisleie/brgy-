...
<head>
    ...
    <title>Barangay Indigency - Proof of Residency</title>
    ...
    <style>
        ...
        .upload-box {
            border-radius: 20px;
            width: 100%;
            height: 300px; /* Set the height of the upload box */
...
<body>
    ...
    <section>
        <img src="bannerimg.png" alt="" class="bannerimage">
    ...
    <div class="container">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <p>* Please upload a barangay id or any proof of residency within the district.</p>
            <div class="button-container">
                <a href="address.php" class="butt">Back</a>
